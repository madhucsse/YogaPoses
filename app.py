...
PREDICTED_LABELS = ["Warrior2","Tree","Plank","Goddess","Downdog"]  # Edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/17958859-b481-4891-ae4c-e50e4a0c4a2c'  #Edit 2-- get endpoint URL from navigator by deploying your onnx model
...
st.title("Welcome to Image Classifier yoga poses App!")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("yoga poses Image Classifier")#change according to your project   #Edit 3
...
with tab2:
  ...
  st.link_button("My Github Repository", "https://github.com/madhucsse/YogaPoses") #Edit 4
  ...
  pdf_url = "https://raw.githubusercontent.com/madhucsse/YogaPoses/main/sample.pdf"
